...
class CardViewAdapter (private val listSkinCare: ArrayList<SkinCare>) : RecyclerView.Adapter<CardViewAdapter.CardViewViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CardViewViewHolder, position: Int) {
        ...
        holder.tvDetail.text = skinCare.detail
